...
for (const [mode, css] of Object.entries(palettes)) {
  ...
  test(`${mode} palette keeps sheets solid and fades chrome backgrounds without touching layout`, () => {
    ...
    assert.match(
      css,
      /html \[data-thread-window\] \[data-follow-up-composer\]:not\(\[data-follow-up-composer-expanded\]\) \[data-promptbox\] \{\n\s*background-color: hsl\(var\(--glass-h\) var\(--glass-s\) var\(--glass-l\) \/ var\(--lg-composer-idle-a, 0\.6\)\) !important;/,
